...
function config.vim_dadbod_ui()
  if packer_plugins["vim-dadbod"] and not packer_plugins["vim-dadbod"].loaded
  then
...
function config.clap()
  ...
  { text = "", texthl = "ClapSelectedSign", linehl = "ClapSelected" }
...
function config.grammcheck()
  -- body
  if not packer_plugins["rhysd/vim-grammarous"]
...
function config.vim_test()
  vim.g["test#strategy"] =
  { nearest = "neovim", file = "neovim", suite = "kitty" }
