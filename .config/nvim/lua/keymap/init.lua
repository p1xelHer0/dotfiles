...
-- Insert mode
k('i', '<Tab>', _G.smart_tab, { expr = true, noremap = true })
k('i', '<S-Tab>', _G.smart_shift_tab, { expr = true, noremap = true })
...
-- Telescope
k('n', '<C-p>', '<Cmd>Telescope find_files<CR>', { silent = true })
k('n', '<Leader>f', '<Cmd>Telescope live_grep<CR>', { silent = true })
k('n', '<Leader>te', '<Cmd>Telescope diagnostics<CR>', { silent = true })
