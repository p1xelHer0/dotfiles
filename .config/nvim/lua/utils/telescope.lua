...
layout.custom = function(self, columns, lines)
  ...
  local height =
  resolve.resolve_height(self.window.results_height)(self, columns, lines)
...
function M.buffers()
  ...
  local buffers = vim.tbl_filter(function(b)
    return (opts.show_all_buffers or vim.api.nvim_buf_is_loaded(b))
...
function M.load_dotfiles()
  ...
  if has_telescope then
    ...
    local results = {}
    local dotfiles = require("core.global").dotfiles
